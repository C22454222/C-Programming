...
int main()
{
    ...
    printf("\n");
    printf("ptr3 contains %c", *ptr3);
    printf("\n");
    //The compiler doesn't know what character is being used with the integer delimeter. It prints out random data.
    printf("ptr3 contains %d", *ptr3);
